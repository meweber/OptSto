...
# TODO :: check correctness of the function
	def dominates (self, other):
		return (self.totalDistance < other.totalDistance and self.totalStanding <= other.totalStanding) or (self.totalDistance <= other.totalDistance and self.totalStanding < other.totalStanding)
...
class View(object):
	...
	def info(self):
		...
		print("|     version : 0.2, 2016-04-17, 12:00                       |")		
		print("+------------------------------------------------------------+")
		print()
